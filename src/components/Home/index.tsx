      ...
      {!loggedIn ? (
        <>
          ...
          <p className={classes}>
            ...
            order to make it one more day. Your currency is chelitos (ch) and
            you can earn it by killing, stealing or saboutaging other players.
            Have fun beefin'!
          </p>
          ...
          <section>
            ...
            <ul>
              <li>
                Once you start beefin' with someone you can mess with them, and
          ...
          <section>
            ...
            <ul>
              ...
              <li className="underline">
                Be ruthless, players will have no mercy
              </li>
            </ul>
          </section>
        </>
